...
# Matrícula: 121110517.
# Objetivo: encontrar o segundo maior e o sengundo menor números de 4 
...
if n1 <= n2 and n1 <= n3 and n1 <= n4:
    if n2 <= n3 and n2 <= n4: 
        ...
        if n3 <= n4:
            ...
            print(f"O segundo maior número é {n4}")
    elif n3 <= n2 and n3 <= n4: 
        print(f"O segundo menor número é {n3}")
        if n2 <= n4:
            print(f"O segundo maior número é {n2}")
        else:
            print(f"O segundo maior número é {n4}")
    elif n4 <= n2 and n4 <= n3:
        print(f"O segundo menor número é {n4}")
        if n2 <= n3:
            print(f"O segundo maior número é {n2}")
        else:
            print(f"O segundo maior número é {n3}")
if n2 <= n1 and n2 <= n3 and n2 <= n4:
    if n1 <= n3 and n1 <= n4:
        print(f"O segundo menor número é {n1}")
        if n3 <= n4:
            print(f"O segundo maior número é {n3}")
        else:
            print(f"O segundo maior número é {n4}")
        ...
        print(f"O segundo menor número é {n3}")
        if n1 <= n4:
            print(f"O segundo maior número é {n1}")
        else:
            print(f"O segundo maior número é {n4}")
